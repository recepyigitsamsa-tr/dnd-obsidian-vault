...
A soul can also be freed by destroying the coin that contains it. A soul coin has AC 19, 1 hit point for each charge it has remaining, and immunity to all damage except that which is dealt by a hellfire weapon|bgdia or an infernal war machine's furnace (see "{@adventure Soul Fuel|bgdia|11|Soul Fuel}").
