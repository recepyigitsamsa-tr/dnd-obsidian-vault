...
A creature that spends 1 hour holding an infernal puzzle box while trying to open it can make a DC 30 Saving Throw Intelligence ({@skill Investigation}) check. If the check succeeds, the creature figures out the trick or sequence of steps needed to open the box. If the check fails by 5 or more, the creature must make a DC 18 Saving Throw Wisdom saving throw, taking 42 (12d6 damage) psychic damage on a failed save, or half as much damage on a successful one.

## Tags

^Tags: #item #rarity_uncommon #type__ #source_bgdia