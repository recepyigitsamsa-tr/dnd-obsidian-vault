...
As an action, you can use the tattoo to cast the disguise self spell spell (DC 13 Saving Throw to discern the disguise). Once the spell is cast from the tattoo, it can't be cast from the tattoo again until the next dawn.
