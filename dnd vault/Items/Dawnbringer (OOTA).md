...
While holding the weapon, you can use an action to touch a creature with the blade and cast lesser restoration spell on that creature. Once used, this ability can't be used again until the next dawn.
...
^Tags: #item #rarity_legendary #type_melee_weapon #attunement #source_oota